...
Technical documentation for OlaClaw's multi-session thread feature.
...
### Global session: `.claude/olaclaw/session.json`
```json
{
  "sessionId": "uuid",
  "createdAt": "ISO8601",
...
### Thread sessions: `.claude/olaclaw/sessions.json`
```json
{
  "threads": {
    "1234567890": {
